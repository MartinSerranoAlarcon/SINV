...
<div class="EncabezadoFactura">
	...
	<tr>
	<th> CEDULA / RUC: </th>
	<td><input type="text" id= "nombrecliente" size="35px" name="idproveedor"></td>
	</tr>
	...
	<tr>
	<th> DIRECCION:</th>
	<td colspan="4"><input type="text" id="direccioncliente" size="50px" name="direccion"></td>
	</tr>
...
<td><center><a href="#" class="botonguardar">
		<span class="icon-save"></span>Modificar
</a></center></td>
</table>
<br><hr><br>
...
<table>
	...
	<td><center><a href="#" class="botonguardar">
		<span class="icon-save"></span>Eliminar
	</a></center></td>
	</table>
    </form>
	<br><br>
