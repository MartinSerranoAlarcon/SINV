...
<div class="EncabezadoFactura">
	...
	<tr>
	<th> CEDULA/ID: </th>
	<td><input type="text" id= "nombrecliente" size="35px" name="ced"></td>
	</tr>

	<tr>
	<th> NOMBRES: </th>
	<td><input type="text" id= "nombrecliente" size="35px" name="nom"></td>
	</tr>

	<tr>
	<th> APELLIDOS: </th>
	<td><input type="text" id= "nombrecliente" size="35px" name="ape"></td>
	</tr>

	<tr>
	<th> DIRECCION:</th>
	<td colspan="4"><input type="text" id="direccioncliente" size="50px" name="dir"></td>
	</tr>

	<tr>
	<th>TELEFONO:</th>
	<td><input type="text" id="telefono" name="tel"></td>
	</tr>
	
	<tr>
	<th> CELULAR:</th>
	<td><input type="text" id="telefono" name="cel"></td>
	</tr>
	</table>
</div>
<table>
