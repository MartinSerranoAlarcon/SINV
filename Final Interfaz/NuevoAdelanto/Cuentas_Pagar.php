...
<div class="Cuentas_Cobrar">
	...
	<tr>
	<th>Abono:</th>
	<td><input type="number" step="any" min="0" id="Abono_Cuenta_Pagar" size="43px" name="abono"></td>
	<th>Fecha:</th>
	...
	<tr>
	<th>Valor:</th>
   	<td><input type="number" step="any" min="0" id="Valor_Cuenta_Pagar" size="43px" name="svalor"></td>
	<th>Estado:</th>
...
<table>
	<td><h2>Cedula /ID del Proveedor:<input type="text" id="direccioncliente" size="20px"></h2></td>
