...
<?php 
    ...
    header("Content-Disposition: attachment; filename=FaltantedeTraspasosEntrantes".$year11."/".$month."/".$day.".xls");
...
<center><table >
  <tr>
    <!--<td>
      ...
      <tr>
          <th id="titulo" colspan="13"><center><strong class="style1">Faltante de Traspasos Entrantes</strong></center></th>
      </tr>
