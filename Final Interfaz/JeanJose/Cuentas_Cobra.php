...
<center> <h1>Cuentas por Cobrar</h1></center>
    ...
    <td><input type="number" step="any" min="0" id= "NombreCliente" size="20px" name="numorden"></td>
    <th>Valor: </th>
	<td><input type="text" id= "Valor_Cuenta_Cobrar" size="25px" name="valor"></td>
    </tr>
	<tr>
	<th>Abono:</th>
	<td><input type="text" id="Abono_Cuenta_Cobrar" size="25px" name="abono"></td>
	<th>Fecha:</th>
	...
	<tr>
    <th>Cuotas: </th>
	<td><input type="number" step="any" min="0" id="Cuotas_Cuenta_Cobrar" name="cuota" size="20px"></td>
	<th>Estado:</th>
