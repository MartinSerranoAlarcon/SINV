...
<form method="POST" >
<table>
	<td><h2>Ingresar el nombre del producto: <input type="text" id="direccioncliente" size="20px" name="txtBusqueda"></h2></td>
	<td><center><!--<a href="#" class="botonguardar">
		<span class="icon-eye"></span>Buscar
	</a>-->
    <input type="submit" value="Buscar" class="botonguardar" name="btnBuscar" ></center></td>
	</table>
